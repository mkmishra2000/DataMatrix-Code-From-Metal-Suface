"""
Code for using median value of data in the decision making process
...
path = 'F:\\books\\5YearFinal_Project\\Internship\\images\\MT_QR11.jpg'
...
# img_bin = cv2.threshold(img, 110, 255, cv2.THRESH_BINARY)[1]
